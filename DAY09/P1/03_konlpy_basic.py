...
# pos : 단와와 품사를 튜플로 만들어 리스트 형태로 반환
result = komo.pos(text)
print(result)

# 형태소 : 의미있는 최소의 단위
# 텍스트 마이닝 : 수많은 텍스트에서 간추려서 의미있는 데이터만 추려 내는 행위
...
#############################################################################################
# 사용자 정의 사전을 활용하는 방법
sentence = '국정 농단 태블릿 PC, 아파파, 가나다라'
komo = Komoran(userdic='user_dic.txt')
print(komo.pos(sentence))
# [('국정', 'NNG'), ('농', 'NNG'), ('단', 'NNG'), ('태블릿 PC', 'NNP'), (',', 'SP'), ('아', 'NNP'), ('파파', 'NNP'), (',', 'SP'), ('가나', 'NNP'), ('다라', 'NNP')]
