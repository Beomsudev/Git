# 05_word2vec_model_test.py

# 이전에 만들어 둔 모델 파일을 읽어, 특정 단어와 유사한 단어들 찾기
# 인접한 유사도를 이ㅛㅇ하여 데이터를 시각화
...
def makePie(piegraph):
    ...
    plt.figure()
    plt.pie(chartdata, colors=mycolor, labels=myticks, startangle=90, explode=(0, 0.05, 0, 0, 0), autopct='%1.2f%%')
...
# most_similar : positive에 명시된 단어에 대하여 유사도가 높은 항목을 topn=n 개만 보여 주세요
