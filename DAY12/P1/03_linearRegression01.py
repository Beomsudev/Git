# 03_linearRegression01.py

# 사이킷런을 이용한 회귀 분석
# 결정 계수 : 실제 값이 예측 값과 얼마 정도의 일치성을 보이는지를 나타내는 척도
# 값은 0 ~ 1 사이의 값으로, 1에 가까우면 설명령이 좋다 라고 표현함.
# R-squared = 1 - ∑(y-H)**2 / ∑(y-bary)**2
# y : 실제 정답, H : 가설로 도출된 값, bary의 실제 정답의 평균 값
...
filename = 'linearTest01.csv'    # 학습용 데이터 셋
...
# 결정 계수 = 1 - RSS/TSS
R_Squared = 1- (RSS/TSS)
print('R_Squared01 : ', R_Squared)

print('R_Squared02 : ', model.score(x_test, y_test))
