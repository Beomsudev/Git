...
y_column = 1
x_cloumn = table_col - y_column

x = data[:, 0:x_cloumn]
# 정답은 현재 문자열로 되어 있습니다.
y_imsi = data[:, x_cloumn:]
# print(y_imsi)

y_imsi = y_imsi.ravel() # 1차원 형식으로 만들기
# print(y_imsi)

# y_imsi 컬럼은 문자열인데, 이것을 숫자형 데이터로 변환 합니다.
...
model.add(Dense(units=NB_CLASSES, input_dim=x_cloumn, activation='softmax'))
